    ...
    <form method="post" action="${pageContext.request.contextPath}/modifierProfile">
        <table class="table0">
            <tr>
                ...
                <td><input class="input0" type="text" name="pseudo" value="${utilisateur.pseudo}" pattern="^[a-zA-Zçéèêëàîïûü.\- 0-9]{2,}$"
            ...
            <tr>
                ...
                <td><input class="input0" type="password" name="nouveauMotDePasse" placeholder="*******" pattern="^(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9])(?=.*[a-z]).{8,}$" required/></td>
                <td><label> Confirmation : </label></td>
                <td><input class="input0" type="password" name="confirmation" placeholder="*******" pattern="^(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9])(?=.*[a-z]).{8,}$" required/></td>
            </tr>
            <tr>
